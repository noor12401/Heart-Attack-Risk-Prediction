...
#Displaying forms for user input
...
if st.button('Predict'):
    if(prediction[0]==0):
        st.write('<p class="big-font">Your risk factor is below 20%. You likely will not develop heart disease in atleast 10 years.</p>',unsafe_allow_html=True)
    else:
